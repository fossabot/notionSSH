...
pub fn run() -> Result<()> {
    ...
    use notion::{append_result_children, build_client, fetch_all_children, is_block_processed, lookup_user_email, ensure_status_block, update_status_block, STATUS_MARKER};
    ...
    // Ensure status block exists once
